...
| :---------------------------: | :----------------: | :-------: | :-----------------------------------------------------------------------------------------: |
| Marga Vicedo and Mark Solovey |    Gary Graham     | Fall 2020 | <div className="flex"><FaStar /><FaStar /><FaStarHalfAlt /><FaRegStar /><FaRegStar /></div> |
...
While this course wasn't bad, the best way I could describe it is "okay." It could have been done a lot better, but it didn't need to be because it was fine just the way it was. I would have definitely taken other courses over it and if you're looking for alternatives, think about [VIC122](https://hisbaan.com/articles/vic122-review), [ANT193](https://hisbaan.com/articles/ant193-review), and [CSC199](https://hisbaan.com/articles/csc199-review) as those are all better courses (although they are all first-year seminar courses).
